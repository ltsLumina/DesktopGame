...
namespace VFolders
{
internal class VFoldersMenuItems
{
    public static bool autoIconsEnabled
    {
        get => EditorPrefs.GetBool("vFolders-autoIconsEnabled", true);
        set => EditorPrefs.SetBool("vFolders-autoIconsEnabled", value);
    }
    public static bool customIconsEnabled
    {
        get => EditorPrefs.GetBool("vFolders-customIconsEnabled", true);
        set => EditorPrefs.SetBool("vFolders-customIconsEnabled", value);
    }

    public static bool foldersFirstEnabled
    {
        get => EditorPrefs.GetBool("vFolders-foldersFirstEnabled", false);
        set => EditorPrefs.SetBool("vFolders-foldersFirstEnabled", value);
    }
    ...
    [MenuItem(autoIcons, true, 1)] static bool dadsaddasadsas()
    {
        Menu.SetChecked(autoIcons, autoIconsEnabled);
        return true;
    }

    [MenuItem(customIcons, false, 2)] static void dadsaadsdadsas() => customIconsEnabled = !customIconsEnabled;

    [MenuItem(customIcons, true, 2)] static bool dadsadadsdasadsas()
    {
        Menu.SetChecked(customIcons, customIconsEnabled);
        return true;
    }
    ...
    [MenuItem(menuDir + "Disable vFolders", false, 103)]
    static void das() => ToggleDefineDisabledInScript(typeof(VFolders));

    // [MenuItem(menuDir + "Disable vFolders", true, 103)]
