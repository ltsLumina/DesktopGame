...
{
internal class VHierarchyMenuItems
{
    const string menuDir = "Tools/vHierarchy/";

    public static bool setActiveEnabled
    {
        get => EditorPrefs.GetBool("vHierarchy-setActiveEnabled", true);
        set => EditorPrefs.SetBool("vHierarchy-setActiveEnabled", value);
    }
    ...
    public static bool expandCollapseEnabled
    {
        get => EditorPrefs.GetBool("vHierarchy-expandCollapseEnabled", true);
        set => EditorPrefs.SetBool("vHierarchy-expandCollapseEnabled", value);
    }
    ...
    {
        get => EditorPrefs.GetBool("vHierarchy-componentMinimapEnabled", true);
        set => EditorPrefs.SetBool("vHierarchy-componentMinimapEnabled", value);
    }
    public static bool iconsEnabled
    {
        get => EditorPrefs.GetBool("vHierarchy-iconsEnabled", true);
        set => EditorPrefs.SetBool("vHierarchy-iconsEnabled", value);
    }
    public static bool collapseAndLightingButtonsEnabled
    {
        get => EditorPrefs.GetBool("vHierarchy-collapseAndLightingButtonsEnabled", true);
        set => EditorPrefs.SetBool("vHierarchy-collapseAndLightingButtonsEnabled", value);
    }
    ...
    [MenuItem(menuDir + "Shortcuts", false, 1)]
    static void dadsas() { }
    [MenuItem(menuDir + "Shortcuts", true, 1)]
    static bool dadsas123() => false;

    [MenuItem(setActive, false, 2)] static void dadsadadsas() => setActiveEnabled = !setActiveEnabled;

    [MenuItem(setActive, true, 2)] static bool dadsaddasadsas()
    {
        Menu.SetChecked(setActive, setActiveEnabled);
        return true;
    }

    [MenuItem(focus, false, 3)] static void dadsadasdadsas() => focusEnabled = !focusEnabled;

    [MenuItem(focus, true, 3)] static bool dadsadsaddasadsas()
    {
    ...
    [MenuItem(delete, true, 4)] static bool dadsaddsasaddasadsas()
    {
    ...
    [MenuItem(expandCollapse, true, 5)] static bool dadsaddsasadadsdasadsas()
    {
        Menu.SetChecked(expandCollapse, expandCollapseEnabled);
        return true;
    }

    [MenuItem(collapseEverythingElse, false, 6)]
    static void dadsadsasdadasdsadadsas() => collapseEverythingElseEnabled = !collapseEverythingElseEnabled;
    [MenuItem(collapseEverythingElse, true, 6)]
    static bool dadsaddsdasasadadsdasadsas()
    {
    ...
    [MenuItem(collapseEverything, true, 7)] static bool dadsaddssdaasadadsdasadsas()
    {
        Menu.SetChecked(collapseEverything, collapseEverythingEnabled);
        return true;
    }

    [MenuItem(menuDir + "Features", false, 101)]
    static void daasddsas() { }
    [MenuItem(menuDir + "Features", true, 101)]
    static bool dadsdasas123() => false;

    [MenuItem(icons, false, 102)] static void dadsadaasdsdadsas() => iconsEnabled = !iconsEnabled;

    [MenuItem(icons, true, 102)] static bool dadsadsadadssaddasadsas()
    {
        Menu.SetChecked(icons, iconsEnabled);
        return true;
    }

    [MenuItem(componentMinimap, false, 103)] static void daadsdsadasdadsas() => componentMinimapEnabled = !componentMinimapEnabled;

    [MenuItem(componentMinimap, true, 103)] static bool dadsadasddasadsas()
    {
        Menu.SetChecked(componentMinimap, componentMinimapEnabled);
        return true;
    }

    [MenuItem(collapseAndLightingButtons, false, 104)]
    static void daadsdsadadsasdadsas() => collapseAndLightingButtonsEnabled = !collapseAndLightingButtonsEnabled;
    [MenuItem(collapseAndLightingButtons, true, 104)]
    static bool dadsadasdsaddasadsas()
    {
        Menu.SetChecked(collapseAndLightingButtons, collapseAndLightingButtonsEnabled);
        return true;
    }

    [MenuItem(menuDir + "More", false, 1001)]
    static void daasadsddsas() { }

    [MenuItem(menuDir + "More", true, 1001)] static bool dadsadsdasas123() => false;

    [MenuItem(menuDir + "Upgrade to vHierarchy 2", false, 102)]
    ...
    [MenuItem(menuDir + "Disable vHierarchy", false, 104)]
    static void das() => ToggleDefineDisabledInScript(typeof(VHierarchy));
    [MenuItem(menuDir + "Disable vHierarchy", true, 104)]
    static bool dassadc()
    {
        Menu.SetChecked(menuDir + "Disable vHierarchy", ScriptHasDefineDisabled(typeof(VHierarchy)));
        return true;
    }
}
}
