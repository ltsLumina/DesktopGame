...
internal sealed class ProjectStructureGUI : EditorWindow
{
    ...
    internal static void Create()
    {
        ...
        foreach (string folder in folderToggleStates.Keys.ToArray()) { folderToggleStates[folder] = EditorGUILayout.Toggle(Path.GetFileName(folder), folderToggleStates[folder]); }
    ...
    static void AddFolderToStates(string folderPath)
    {
        ...
        foreach (string subfolder in Directory.GetDirectories(folderPath)) { folderToggleStates.Add(subfolder, false); }
    }
