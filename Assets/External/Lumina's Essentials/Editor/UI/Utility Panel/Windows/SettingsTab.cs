...
internal sealed partial class UtilityPanel
{
    ...
    void DisplaySafeModeWarning()
    {
        ...
        bool userDisabledSafeMode = EditorUtility.DisplayDialog("Warning!", "Safe Mode has not been disabled and is required to reset the Utility Window.", "Disable Safe Mode", "Cancel");
